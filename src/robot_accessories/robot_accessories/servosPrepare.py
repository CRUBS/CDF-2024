...
class servoPrepareNode(Node):
	def __init__(self):
		...
		# ouvert
		# defaut
		self.posPick = [[150,30],[130,50],[110,70],[180,0]]
		self.posElev = [10, 60, 80, 150]
		self.posSolar = [0, 130]
	...
	def callback_update_servos(self,msg):
		...
		match int(servoCmdMsg1):
			...
			case 0:
				...
				self.servoCmd[1] = int(self.posPick[2][1])
				self.servoCmd[2] = int(self.posPick[2][0])
			# Ouvert bas pot
			case 1:
		...
		match int(servoCmdMsg2):
			# Ouvert bas plante
			case 0:
				self.servoCmd[3] = int(self.posElev[1])
				self.servoCmd[4] = int(self.posPick[2][1])
				self.servoCmd[5] = int(self.posPick[2][0])
			# Ouvert bas pot
			case 1:
				self.servoCmd[3] = int(self.posElev[0])
				self.servoCmd[4] = int(self.posPick[2][0])
				self.servoCmd[5] = int(self.posPick[2][1])
			# Ferme bas plante 
			case 2:
				self.servoCmd[3] = int(self.posElev[0])
				self.servoCmd[4] = int(self.posPick[0][0])
				self.servoCmd[5] = int(self.posPick[0][1])
			# Ferme bas pot
			case 3:
				self.servoCmd[3] = int(self.posElev[0])
				self.servoCmd[4] = int(self.posPick[1][0])
				self.servoCmd[5] = int(self.posPick[1][1])
			# Ferme transport
			case 4:
				self.servoCmd[3] = int(self.posElev[3])
				self.servoCmd[4] = int(self.posPick[0][0])
				self.servoCmd[5] = int(self.posPick[0][1])
			# Laisse tomber
			case 5:
				self.servoCmd[3] = int(self.posElev[2])
				self.servoCmd[4] = int(self.posPick[2][0])
				self.servoCmd[5] = int(self.posPick[2][1])
			#Position de repos
			case _:
				self.servoCmd[3] = int(self.posElev[0])
				self.servoCmd[4] = int(self.posPick[3][0])
				self.servoCmd[5] = int(self.posPick[3][1])
