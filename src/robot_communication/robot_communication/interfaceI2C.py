...
class i2cInterface(Node):
	def __init__(self):
		...
		self.publisherImu = self.create_publisher(Imu, '/imu', 10)
	...
	def timer_motors_callback(self):
		...
		self.i2cBusy = False
		self.publisherTimerStatusMotors.publish(msgStatus)
		
	def timer_encoders_callback(self):
		# Function sending encoders measurements
		msgStatus = String()
		msgStatus.data = "encoders ok"
		msgE1 = Int16()
		msgE2 = Int16()
		msgE3 = Int16()
		...
		msgE1.data = int.from_bytes(resultE1, "big")
		msgE2.data = int.from_bytes(resultE2, "big")
